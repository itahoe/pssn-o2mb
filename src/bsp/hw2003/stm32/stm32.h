...
/*
void    stm32_led_mdbs_init( void );
bool    stm32_led_mdbs_get( void );
void    stm32_led_mdbs_set( const bool );
void    stm32_led_mdbs_hook( void );
void    stm32_led_mdbs_flash( const size_t );
*/
/*
void    stm32_led_pwr_init( void );
bool    stm32_led_pwr_get( void );
void    stm32_led_pwr_set( const bool );
void    stm32_led_pwr_hook( void );
void    stm32_led_pwr_flash( const size_t );
*/
