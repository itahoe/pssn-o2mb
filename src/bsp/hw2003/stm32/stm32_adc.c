...
init_io( void )
{
	GPIO_InitTypeDef        pin_adc         =   {    .Pin       =    GPIO_PIN_0,
	                                                 .Mode      =    GPIO_MODE_ANALOG,
	                                                 .Pull      =    GPIO_NOPULL,
	                                                 .Speed     =    GPIO_SPEED_FREQ_LOW };

	HAL_GPIO_Init( GPIOB, &pin_adc );
}
...
stm32_adc_init( void )
{
        ...
        NVIC_SetPriority(       DMA1_Channel1_IRQn,     STM32_NVIC_PRIO_GENERIC );
        NVIC_EnableIRQ(         DMA1_Channel1_IRQn                              );  

        NVIC_SetPriority(       TIM15_IRQn,             STM32_NVIC_PRIO_GENERIC );
