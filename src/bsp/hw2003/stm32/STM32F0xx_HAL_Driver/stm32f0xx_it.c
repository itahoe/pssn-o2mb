...
*******************************************************************************/
/**
  * @brief  SPI1 global interrupt request handling
  * @param  None
  * @retval None
  */
void
...
{
        int     idle    = stm32_usart1_isr_is_idle();
...
*******************************************************************************/
/**
  * @brief  USART2 interrupt request handling
  * @param  None
  * @retval None
  */
/*
...
{
        int     idle    = stm32_usart2_isr_is_idle();
