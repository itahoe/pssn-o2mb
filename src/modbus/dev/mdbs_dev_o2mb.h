...
typedef enum    mdbs_hreg_e
{
        ...
        MDBS_HREG_DEVICE_ID                     = 0,
        MDBS_HREG_HARDWARE_ID,
        MDBS_HREG_RESERVED_02,
        MDBS_HREG_RESERVED_03,
        MDBS_HREG_FIRMWARE_ID_HI,
        MDBS_HREG_FIRMWARE_ID_LO,
        MDBS_HREG_RESERVED_06,
        ...
        MDBS_HREG_ADC_SCALE_mV,
        MDBS_HREG_ADC_RESOLUTION_BITS,
        ...
        MDBS_HREG_CONF_RESERVED_0106,
        MDBS_HREG_CONF_RESERVED_0107,
        ...
        MDBS_HREG_CONF_RESERVED_0142,
        MDBS_HREG_CONF_RESERVED_0143,
        MDBS_HREG_CONF_AFE_BIAS,
        MDBS_HREG_CONF_RESERVED_0145,
        MDBS_HREG_CONF_RESERVED_0146,
        MDBS_HREG_CONF_RESERVED_0147,
        MDBS_HREG_CONF_AFE_DRIFT_K_TEMP_HI,
        MDBS_HREG_CONF_AFE_DRIFT_K_TEMP_LO,
        MDBS_HREG_CONF_RESERVED_014A,
        MDBS_HREG_CONF_RESERVED_014B,
        MDBS_HREG_CONF_AFE_DRIFT_K_PRES_HI,
        MDBS_HREG_CONF_AFE_DRIFT_K_PRES_LO,
        MDBS_HREG_CONF_RESERVED_014E,
        MDBS_HREG_CONF_RESERVED_014F,

        MDBS_HREG_CONF_AD7799_MODE              = 0x0150,
        MDBS_HREG_CONF_AD7799_CONF,
        MDBS_HREG_CONF_RESERVED_0152,
        MDBS_HREG_CONF_RESERVED_0153,
        MDBS_HREG_CONF_AD7799_CHANNEL,
        MDBS_HREG_CONF_AD7799_GAIN,
        MDBS_HREG_CONF_RESERVED_0156,
        MDBS_HREG_CONF_RESERVED_0157,
        MDBS_HREG_CONF_RESERVED_0158,
        MDBS_HREG_CONF_RESERVED_0159,
        MDBS_HREG_CONF_RESERVED_015A,
        MDBS_HREG_CONF_RESERVED_015B,
        MDBS_HREG_CONF_RESERVED_015C,
        MDBS_HREG_CONF_RESERVED_015D,
        MDBS_HREG_CONF_RESERVED_015E,
        MDBS_HREG_CONF_RESERVED_015F,


        //V2 MEAS
        MDBS_HREG_MEAS_CONCENTRATION_PPM_HI     = 0x0200,
        MDBS_HREG_MEAS_CONCENTRATION_PPM_LO,
        MDBS_HREG_MEAS_TEMPERATURE_DIGC_HI,
        MDBS_HREG_MEAS_TEMPERATURE_DIGC_LO,
        MDBS_HREG_MEAS_PRESSURE_HPA_HI,
        MDBS_HREG_MEAS_PRESSURE_HPA_LO,
        MDBS_HREG_MEAS_RESERVED_0206,
        MDBS_HREG_MEAS_RESERVED_0207,
        MDBS_HREG_MEAS_CONCENTRATION_SLOPE_RAW,
        MDBS_HREG_MEAS_SENSOR_OFFSET_RAW,
        MDBS_HREG_MEAS_RESERVED_020A,
        MDBS_HREG_MEAS_RESERVED_020B,
        MDBS_HREG_MEAS_MCU_TEMP_DIGC,
        MDBS_HREG_MEAS_MCU_VDDA_mV,
        MDBS_HREG_MEAS_RESERVED_020E,
        MDBS_HREG_MEAS_RESERVED_020F,

        MDBS_HREG_MEAS_ADC_RAW_HI               = 0x0210,
        MDBS_HREG_MEAS_ADC_RAW_LO,
        MDBS_HREG_MEAS_TEMPERATURE_RAW_HI,
        MDBS_HREG_MEAS_TEMPERATURE_RAW_LO,
        MDBS_HREG_MEAS_PRESSURE_RAW_HI,
        MDBS_HREG_MEAS_PRESSURE_RAW_LO,
        MDBS_HREG_MEAS_RESERVED_0216,
        MDBS_HREG_MEAS_RESERVED_0217,
        MDBS_HREG_MEAS_RESERVED_0218,
        MDBS_HREG_MEAS_RESERVED_0219,
        MDBS_HREG_MEAS_RESERVED_021A,
        MDBS_HREG_MEAS_RESERVED_021B,
        MDBS_HREG_MEAS_RESERVED_021C,
        MDBS_HREG_MEAS_RESERVED_021D,
        MDBS_HREG_MEAS_RESERVED_021E,
        MDBS_HREG_MEAS_RESERVED_021F,

        //V2 STS
        MDBS_HREG_STS_LAST_ERROR                = 0x0300,
        MDBS_HREG_STS_STARTS_COUNTER,
        MDBS_HREG_STS_RESERVED_0302,
        MDBS_HREG_STS_RESERVED_0303,
        MDBS_HREG_STS_RESERVED_0304,
        MDBS_HREG_STS_RESERVED_0305,
        MDBS_HREG_STS_RESERVED_0306,
        MDBS_HREG_STS_RESERVED_0307,
        MDBS_HREG_STS_RESERVED_0308,
        MDBS_HREG_STS_RESERVED_0309,
        MDBS_HREG_STS_RESERVED_030A,
        MDBS_HREG_STS_RESERVED_030B,
        MDBS_HREG_STS_RESERVED_030C,
        MDBS_HREG_STS_RESERVED_030D,
        MDBS_HREG_STS_RESERVED_030E,
        MDBS_HREG_STS_RESERVED_030F,
