...
typedef enum    mdbs_hreg_e
{
        ...
        MDBS_HREG_SENS_OXGN_PPM_HI,
        MDBS_HREG_SENS_OXGN_PPM_LO,
        MDBS_HREG_SENS_TEMP_CELS_HI,
        MDBS_HREG_SENS_TEMP_CELS_LO,
        MDBS_HREG_SENS_PRES_HPA_HI,
        MDBS_HREG_SENS_PRES_HPA_LO,
        MDBS_HREG_SENS_SLOPE,
        MDBS_HREG_SENS_OFST_RAW,
        MDBS_HREG_SENS_RAW_HI,
        MDBS_HREG_SENS_RAW_LO,
        MDBS_HREG_RESERVED_2A,
        MDBS_HREG_RESERVED_2B,
        MDBS_HREG_RESERVED_2C,
        MDBS_HREG_RESERVED_2D,
        MDBS_HREG_RESERVED_2E,
        MDBS_HREG_RESERVED_2F,

        MDBS_HREG_SENS_R0_TRIM_P0_HI,
        MDBS_HREG_SENS_R0_TRIM_P0_LO,
        MDBS_HREG_SENS_R0_TRIM_P0_TIMESTAMP_HI,
        MDBS_HREG_SENS_R0_TRIM_P0_TIMESTAMP_LO,
        MDBS_HREG_SENS_R0_TRIM_P1_HI,
        MDBS_HREG_SENS_R0_TRIM_P1_LO,
        MDBS_HREG_SENS_R0_TRIM_P1_TIMESTAMP_HI,
        MDBS_HREG_SENS_R0_TRIM_P1_TIMESTAMP_LO,
