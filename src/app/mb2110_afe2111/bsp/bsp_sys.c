...
bsp_sys_device_id(                              const   size_t          idx  )
{
        ...
        const   uint8_t id[]  = { 0x01, 0x02, 0x03, 0x04, };
...
bsp_sys_serial_num(                             const   size_t          idx )
{
        ...
        switch( idx )
        {
                case 0:         u16     = 0x0000;       break;
                case 1:         u16     = 0x1111;       break;
                case 2:         u16     = 0x2222;       break;
                case 3:         u16     = 0x3333;       break;
                case 4:         u16     = 0x4444;       break;
                case 5:         u16     = 0x5555;       break;
                case 6:         u16     = 0x6666;       break;
                case 7:         u16     = 0x7777;       break;
