...
ad7799_sts_ready( void )
{
	...
	ad7799_x_enable( true );
        reg     = ad7799_x_xfer( 0xFF );
	ad7799_x_enable( false );

        //printf( "reg & AD7799_STS_READY: %s\n", (reg & AD7799_STS_READY) ? "false" : "true" );

        return( (reg & AD7799_STS_READY) ? false : true );
}
...
ad7799_set_channel(                     const   ad7799_chnl_t   chnl )
{
        ...
        switch( chnl )
        {
                case AD7799_CHNL_AIN1P_AIN1M:
                case AD7799_CHNL_AIN2P_AIN2M:
                case AD7799_CHNL_AIN3P_AIN3M:
                case AD7799_CHNL_AIN1M_AIN1M:
                case AD7799_CHNL_AVDD_MONITOR:
                        reg     &= ~( 0x7 << 0 );
                        reg     |= ( chnl << 0 );
                        ad7799_write( AD7799_REG_CONF, reg, 2 );
                        err     = 0;
...
ad7799_read_single( void )
{
        ...
        do
        {
                not_ready = ad7799_read( AD7799_REG_STS, 1 ) & AD7799_STS_READY;
        } while( not_ready );
